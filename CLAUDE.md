...
**Launch readiness:** v2.0 is scoped to **caregiver + patient personas only**. Doctor portal, doctor onboarding, and doctor-facing analytics are deferred to **Phase 2** (see `docs/v2_launch_plan.md` §13). The launch plan tracks beta and GA gates, the 16 in-scope untested journeys, doc backfill, and infra/compliance streams. Open fixes and journey results live in `docs/testing_todos_v2.md`, `docs/journeys_non_voice.md`, and `docs/journeys_voice.md`. iOS is **parked** for v2.0 — Android only.
