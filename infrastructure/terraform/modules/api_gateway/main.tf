...
resource "aws_api_gateway_deployment" "main" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      # PRD §6.9 / Spec §4.6 — Care Notes routes (see care_notes_routes.tf)
      aws_api_gateway_resource.patient_care_notes.id,
      aws_api_gateway_resource.patient_care_note.id,
      aws_api_gateway_resource.patient_care_note_acknowledge.id,
      aws_api_gateway_method.patient_care_notes_get.id,
      aws_api_gateway_integration.patient_care_notes_get.id,
      aws_api_gateway_method.patient_care_note_acknowledge_post.id,
      aws_api_gateway_integration.patient_care_note_acknowledge_post.id,
      aws_api_gateway_resource.caregivers.id,
      aws_api_gateway_resource.caregiver.id,
      aws_api_gateway_resource.caregiver_care_notes.id,
      aws_api_gateway_resource.caregiver_care_notes_unread_count.id,
      aws_api_gateway_method.caregiver_care_notes_unread_count_get.id,
      aws_api_gateway_integration.caregiver_care_notes_unread_count_get.id,
