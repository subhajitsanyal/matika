...
| PT-V2-06 | **flow-authored; ready for re-run after F25 fix (2026-05-10)** | 2026-05-10 first run: lang=bn-IN session created, gTTS Bengali audio plays, Soda returned error 12 LANGUAGE_NOT_SUPPORTED, hard-failed. F25 fix lands silent online fallback for error 12/13. Re-run expected to PASS via the online STT path with logcat showing `stt_offline_used=false`. |
